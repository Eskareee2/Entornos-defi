package azahartech.eventdev.presentacion;

import azahartech.eventdev.modelo.*;
import azahartech.eventdev.pagos.PagoPayPal;
import azahartech.eventdev.pagos.PagoTarjeta;
import azahartech.eventdev.pagos.ProcesadorPago;
import azahartech.eventdev.servicio.ServicioEvento;
...
/*
        Recinto recinto1 = new Recinto("Recinto muyyy chulo", "Calle muyyy chula", 200);
        Evento concierto1 = new Concierto("Concierto de Lenna6", recinto1, "Lenna6", fecha1, "EVT-2007-AAA", 3000);
        Evento partido1 = new Partido("Clasico", recinto1, "Barsa", "Madriz", fecha1, "EVT-2007-BBB", 1000, 800);
        Evento concierto2 = new Concierto("Concierto de Lenna7", recinto1, "Lenna7", fecha1, "EVT-2007-CCC", 3000);
        Evento partido2 = new Partido("Clasico2", recinto1, "Halicante", "Albasete", fecha1, "EVT-2007-DDD", 1000, 800);
        Usuario Kenneth = new Usuario("Kenneth", "KennethYMarko@gmail.com", true);
        ServicioEvento servicioEvento = new ServicioEvento(concierto1, Kenneth);
        ...
        Recinto recinto1 = new Recinto("Recinto muyyy chulo", "Calle muyyy chula", 200);
        Usuario Marko = new Usuario("Marko", "KennethYMarko@gmail.com", true);
        Recinto recinto2 = new Recinto("Recinto muyyy chulo", "Calle muyyy chula", 200);
        Concierto concierto1 = new Concierto("Concierto de Lenna7", recinto2, "Lenna7", fecha1, "EVT-2007-CCC", 3000, 10);

        ArrayList<Exportable> listaMezclada = new ArrayList<>();

        Exportable concierto2 = new Concierto("Concierto de Lenna7", recinto1, "Lenna7", fecha1, "EVT-2007-CCC", 3000, 10);
        Exportable partido2 = new Partido("Clasico2", recinto1, "Halicante", "Albasete", fecha1, "EVT-2007-DDD", 1000, 800);
        Exportable Kenneth = new Usuario("Kenneth", "KennethYMarko@gmail.com", true);
        Exportable tique = new Tique(concierto1, Marko);

        listaMezclada.add(concierto2);
        listaMezclada.add(partido2);
        listaMezclada.add(Kenneth);
        listaMezclada.add(tique);

        UtilidadExportacion.exportarLista(listaMezclada);


        ArrayList<Notificable> destinatarios = new ArrayList<>();

        Notificable Viktor = new Usuario("Viktor", "Vik@gmail.com", true);
        Administrador Karlos = new Administrador("Bienvenidos");

        destinatarios.add(Viktor);

        String mensajeBienvenida = "¡Bienvenido al sistema!";

       /* for (Notificable n : destinatarios) {
            n.enviarNotificacion(mensajeBienvenida);
        }

        ArrayList<Usuario> listaUsuarios = new ArrayList<>();


        Usuario Pau = new Usuario("Pau", "Pau@gmail.com", true);
        Usuario PauPau = new Usuario("PauPau", "PauPau@gmail.com", true);
        Usuario PauPauPau = new Usuario("PauPauPau", "PauPauPau@gmail.com", true);

        listaUsuarios.add(Pau);
        listaUsuarios.add(PauPau);
        listaUsuarios.add(PauPauPau);

       // System.out.println("Antes de ordenar: " + listaUsuarios);
        listaUsuarios.sort(null);
        //System.out.println("Despues de ordenar" + listaUsuarios);

        Usuario Pau = new Usuario("Pau", "Pau@gmail.com", true);
        ServicioEvento servicio = new ServicioEvento(concierto1, Pau);
        ProcesadorPago miTarjeta = new PagoTarjeta("1234567890123456", "12/28");
        servicio.realizarCompra(Pau, concierto1, 2, miTarjeta);
        PagoTarjeta pago1 = new PagoTarjeta("1111111111111111", "03/02");
        pago1.procesarPago(2);

        ProcesadorPago miPayPal = new PagoPayPal("alba@azahar.tech");
        servicio.realizarCompra(Pau, concierto1, 1, miPayPal);
*/
        Recinto recinto1 = new Recinto("Recinto muyyy chulo", "Calle muyyy chula", 200);
        Evento concierto1 = new Concierto("Concierto de Lenna6", recinto1, "Lenna6", fecha1, "EVT-2007-AAA", 3000, 7.0, TipoEvento.CONCIERTO);
        concierto1.activarVenta();
        concierto1.registrarVenta(1);
       concierto1.cancelarEvento();
        concierto1.registrarVenta(1);
